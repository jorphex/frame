...
| --------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accounts        | `eth_accounts`, `eth_requestAccounts`, `eth_coinbase`                                           | `eth_accounts` and `eth_coinbase` are passive: before permission they return `[]` and `null` without prompting. `eth_requestAccounts` explicitly requests access, and all three expose only the selected Frame account after the origin has permission. Watch-only accounts remain available for reads, but Frame rejects their signing requests before pending submission state. |
