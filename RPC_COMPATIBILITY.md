...
| --------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accounts        | `eth_accounts`, `eth_requestAccounts`, `eth_coinbase`                                           | Return the selected Frame account. Account access is permission-gated at the transport boundary.                                                                                                                                                                                                      |
...
| Transactions    | `eth_sendTransaction`                                                                           | Normalizes, decodes, checks, simulates, reviews, signs, and broadcasts legacy/type-1/type-2 transactions. Successful single-call checks optionally include a bounded configured-RPC native balance diff. Explicit type 3+, EIP-7702 authorization lists, and unknown transaction fields are rejected. |
