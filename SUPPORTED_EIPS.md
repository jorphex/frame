...
| [ERC-1271](https://eips.ethereum.org/EIPS/eip-1271) | Unsupported | Frame supports canonical watch-only accounts and displays chain-scoped configured-RPC code presence, but does not infer ERC-1271 or Safe support from bytecode. Contract-signature validation and Safe signing flows are not implemented; watch-only signing requests fail before submission.           |
