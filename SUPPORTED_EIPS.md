...
| [ERC-1271](https://eips.ethereum.org/EIPS/eip-1271) | Unsupported | Frame supports canonical watch-only accounts, but rejects their transaction, message, typed-data, and wallet-call signing requests before submission. Contract-account detection, signature validation, and Safe signing flows are not implemented.                                                     |
