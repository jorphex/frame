...
| [EIP-747](https://eips.ethereum.org/EIPS/eip-747)   | Partial     | `wallet_watchAsset` supports checksummed legacy ERC-20 and ERC-1046 ERC-20 suggestions on connected chains. ERC-1046 metadata is bounded to inline JSON or IPFS through Frame's configured Kubo endpoint, reconciled with contract reads, and validated before acknowledgement; arbitrary HTTP(S) and image fetches are rejected. NFT asset suggestions remain unsupported. |
